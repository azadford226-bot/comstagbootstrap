 ...
 */
export function initDevAuth(userType: "ORGANIZATION" | "CONSUMER" | "ADMIN" = "ORGANIZATION") {
  ...
  if (userType === "ADMIN") {
    setUserEmail("admin@comstag.com");
    setUserName("Admin User");
    setUserType("ADMIN");
  } else if (userType === "CONSUMER") {
    setUserEmail(DEV_MOCK_CONSUMER_PROFILE.email);
    setUserName(DEV_MOCK_CONSUMER_PROFILE.displayName);
  ...
  console.log(`%c✅ Mock authentication initialized as ${userType}`, "color: #10B981;");
  console.log(
  ...
  if (userType === "ADMIN") {
    ...
    console.log("  • /profile - View consumer profile");
    console.log("  • /consumer-profile - Consumer profile");
  } else {
