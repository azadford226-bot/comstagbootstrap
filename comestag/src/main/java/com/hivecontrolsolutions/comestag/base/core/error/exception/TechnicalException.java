...
public class TechnicalException extends RuntimeException {
    ...
    public TechnicalException(String message, List<String> fields) {
        super(message);
        errorMessage = message;
        this.internalStatus = UNKNOWN_ERROR;
        this.fields = fields;
    ...
    public TechnicalException(InternalStatusError internalStatus) {
        super(internalStatus.getDefaultMessage());
        errorMessage = internalStatus.getDefaultMessage();
        this.internalStatus = internalStatus;
    }

    public TechnicalException(InternalStatusError internalStatus, List<String> fields) {
        super(internalStatus.getDefaultMessage());
        errorMessage = internalStatus.getDefaultMessage();
        this.internalStatus = internalStatus;
        this.fields = fields;
    ...
    public TechnicalException(InternalStatusError internalStatus, String errorMessage) {
        super(errorMessage);
        this.internalStatus = internalStatus;
    ...
    public TechnicalException(InternalStatusError internalStatus, String errorMessage, List<String> fields) {
        super(errorMessage);
        this.internalStatus = internalStatus;
        this.errorMessage = errorMessage;
        this.fields = fields;
