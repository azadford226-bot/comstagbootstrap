...
public class UnregisterFromEventUseCase implements UsecaseWithoutOutput<UnregisterFromEventUseCase.Input> {
    ...
    public void execute(Input input) {
        ...
        registrationPort.unregister(input.eventId(), input.accountId());
    }
}
